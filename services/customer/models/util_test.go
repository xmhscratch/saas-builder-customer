...
func TestParseString(t *testing.T) {
	parsedValue, err := models.ParseString(UNICODE_TEST_PARAGRAPH)
	if err != nil {
...
func TestParseInt(t *testing.T) {
	...
	parsedValue, err = models.ParseInt(int32(123456789))
	if err != nil {
		t.Errorf("failed: %v", err)
		return
	}
	...
	parsedValue, err = models.ParseInt(int64(123456789))
	if err != nil {
		t.Errorf("failed: %v", err)
		return
	}
	...
	parsedValue, err = models.ParseInt(float32(123456789.0000))
	if err != nil {
		t.Errorf("failed: %v", err)
		return
	}
	...
	parsedValue, err = models.ParseInt(float64(123456789.0000))
	if err != nil {
		t.Errorf("failed: %v", err)
		return
	}
	...
	parsedValue, err = models.ParseInt(string("123456789"))
	if err != nil {
		t.Errorf("failed: %v", err)
		return
	}
...
func TestParseTime(t *testing.T) {
	...
	parsedValue, err = models.ParseTime("2019-11-13T09:47:00.000Z")
	if err != nil {
		t.Errorf("failed: %v", err)
		return
	}
	...
	parsedValue, err = models.ParseTime(int32(1573466263))
	if err != nil {
		t.Errorf("failed: %v", err)
		return
	}
	...
	parsedValue, err = models.ParseTime(int64(1573466263))
	if err != nil {
		t.Errorf("failed: %v", err)
		return
	}
	...
	parsedValue, err = models.ParseTime(float32(1573466263.0000))
	if err != nil {
		t.Errorf("failed: %v", err)
		return
	}
	...
	parsedValue, err = models.ParseTime(float64(1573466263.0000))
	if err != nil {
		t.Errorf("failed: %v", err)
		return
	}
...
func TestSimplifyFractions(t *testing.T) {
	// log.Println(models.SimplifyFractions(4.4, 8.4))
	t.Fail()
}
